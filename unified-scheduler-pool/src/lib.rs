    ...
    TH: TaskHandler,
{
    ...
    pub fn create_banking_scheduler(&self, bank_forks: &BankForks, recv: BankingPacketReceiver, on_banking_packet_receive: impl Fn(BankingPacketBatch) + Send + 'static) -> Arc<dyn BlockProducingScheduler> {
