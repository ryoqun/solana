    ...
    TH: TaskHandler,
{
    ...
    pub fn create_banking_scheduler(&self, bank_forks: &BankForks, recv: BankingPacketReceiver, on_banking_packet_receive: impl Fn() + Send + 'static) -> Arc<dyn BlockProducingScheduler> {
    ...
    TH: TaskHandler,
{
    fn take_resumed_scheduler(
        ...
        Box::new(self.do_take_resumed_scheduler(context, result_with_timings, None::<(_, fn())>))
    }
