...
pub const OPT_OUT_DEFAULT_BANKING_TRACE_SIZE: u64 = TRACE_FILE_DEFAULT_ROTATE_BYTE_THRESHOLD * TRACE_FILE_ROTATE_COUNT;
pub const OPT_IN_DEFAULT_BANKING_TRACE_SIZE: u64 = EMPTY_BANKING_TRACE_SIZE;
