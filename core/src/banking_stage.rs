...
use {
    crate::{
        banking_trace::{BankingPacketReceiver, BankingTracer, TracerThread, TracerThreadResult},
...
impl BankingStage {
    ...
    pub fn new(
        ...
        banking_tracer_with_thread: (TracerThread, Arc<BankingTracer>),
    ) -> Self {
