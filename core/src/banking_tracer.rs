...
impl BankingTracer {
    ...
    pub fn channel(maybe_mirrored_channel: usize, name: &'static str) -> (TracedBankingPacketSender, crossbeam_channel::Receiver<(Vec<PacketBatch>, std::option::Option<SigverifyTracerPacketStats>)>) {
