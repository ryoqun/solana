...
use {
    ...
    spl_token_v2_0::solana_program::program_pack::Pack,
                ...
                match load_bank_forks(
                    ...
                    Ok((bank_forks, _leader_schedule_cache, _snapshot_hash)) => {
                        ...
                        for (mint_address, mint) in &mints {
                            if let Some((calculated_count, calculated_supply, num_empty_accounts)) = supplies_by_mint.get(&spl_token_v2_0::solana_program::pubkey::Pubkey::new(&mint_address.to_bytes())) {
                                ...
                                println!("  num_empty_accounts: {}", num_empty_accounts);
                            } else {
