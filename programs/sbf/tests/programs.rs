...
fn test_cpi_account_ownership_writability() {
    ...
    for direct_mapping in [true] {
        ...
        for target_account in [account_metas.len() as u8 - 1] {
            ...
            account.data_as_mut_slice(..33).copy_from_slice(&[0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x28, 0x00, 0x00, 0x04, 0x00, 0x00, 0x00, 0x32]);
